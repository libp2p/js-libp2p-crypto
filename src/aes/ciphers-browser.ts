...
export function createCipheriv (mode: any, key: Uint8Array, iv: Uint8Array): { update: (data: Uint8Array) => Uint8Array } {
...
export function createDecipheriv (mode: any, key: Uint8Array, iv: Uint8Array): { update: (data: Uint8Array) => Uint8Array } {
